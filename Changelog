...
- Changed mod GUID
- Translated each of enemy's and item's name (Russian -> English) (partially)
- Improved structure of project
- Reduced chance of spawning custom items and enemies
- Added Accordionman
- Added guitar
- Fixed position of Tsoi portrait
- Fixed errors in each of AIs
- Fixed items' positions in hand
